...
private:
	...
	Texture2D Attaque0, Attaque1, Attaque2, Attaque3, Attaque4, Attaque5;

	Rectangle frameRecDroite;
	Rectangle frameRecGauche;
	Rectangle frameRecDroiteAttaque;
	Rectangle frameRecGaucheAttaque;
...
public:
	...
	void animation_attaque_droite(Vector2 position, int currentFrame);
	void animation_attaque_gauche(Vector2 position, int currentFrame);
