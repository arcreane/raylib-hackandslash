...
{
    this->frameRec = { 112.0f, -119.0f, 56, 40 };
...
{
    if (currentFrame == 0) DrawTextureRec(this->RunLoop0, this->frameRec, position, WHITE);
    if (currentFrame == 1) DrawTextureRec(this->RunLoop1, this->frameRec, position, WHITE);
    if (currentFrame == 2) DrawTextureRec(this->RunLoop2, this->frameRec, position, WHITE);
    if (currentFrame == 3) DrawTextureRec(this->RunLoop3, this->frameRec, position, WHITE);
    if (currentFrame == 4) DrawTextureRec(this->RunLoop4, this->frameRec, position, WHITE);
    if (currentFrame == 5) DrawTextureRec(this->RunLoop5, this->frameRec, position, WHITE);
}
